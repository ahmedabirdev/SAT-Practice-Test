  ...
  useEffect(() => {
    ...
    if (saved) {
      try {
        ...
        console.error("Invalid section2 data in localStorage", err);
      }
    }
  }, []);
  ...
  const handleOptionSelect = (questioninfo, realanswer, selectedOption) => {
    ...
    if (existingInputIndex >= 0) {
      ...
      updatedInputs.push({
        ...
        highlightedText: "", // Initialize highlightedText
      });
    }
  ...
  const handleTextHighlight = (event) => {
    if (highlightMode) {
      ...
      if (selection.rangeCount > 0) {
        ...
        setSection2Data(updatedSection2Data);
        localStorage.setItem("section1", JSON.stringify(updatedSection2Data));
      ...
      {dirrection && (
        <div className="w-[50%] h-[35vh] bg-white shadow-2xl fixed top-[10vh] left-[5vh] px-5 py-10">
          <p>
            ...
            and writing skills. Each question includes one or import {useNavigate} from 'react-router-dom';
            more passages,
                ...
                <div className="w-[90%] grid  grid-cols-10">
                  {SAT_Section1_Module2.map((_, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-10 h-10 text-xl relative ${isAnswered
              ...
              <div className="pl-5 flex flex-col gap-2 w-[95%]">
                {currentQuestion.options.map((option, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`cursor-pointer p-2 border-2 rounded-lg ${isSelected ? "border-green-500" : ""
                    ...
                    {SAT_Section1_Module2.map((_, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div
                            className={`w-6 h-6 text-sm relative ${isAnswered
                                ? "bg-green-600 text-white"
                                : "border-2 border-dashed bor text-black border-[#000000b3]"
                              } rounded-sm center font-bold  `}
                          >
